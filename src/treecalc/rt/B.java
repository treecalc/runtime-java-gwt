...
public final class B {
	...
	private static final String REGEX_YMD = "^[0-9][0-9][0-9][0-9][-][0-9][0-9]?[-][0-9][0-9]?$";
	private static final String REGEX_DMY = "^[0-9][0-9]?[.][0-9][0-9]?[.][0-9][0-9][0-9][0-9]$";
	private static final String REGEX_MDY = "^[0-9][0-9]?[/][0-9][0-9]?[/][0-9][0-9][0-9][0-9]$";
	...
	public static final V formatDate(final int[] ymd, final int[] hms, final V format)  {
        ...
        while (c!=CharacterIterator.DONE) {
            ...
            case 'w': // day of the week as number, starting with 0 at sunday
                buf.append(new Date(year-1900, month-1, day).getDay()-1);
                break;
            case 'W': // day of the week as text
                final int indDay = new Date(year-1900, month-1, day).getDay()-1;
